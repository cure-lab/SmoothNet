...
cfg.EVALUATE.TRADITION_SAVGOL.WINDOW_SIZE=11
cfg.EVALUATE.TRADITION_SAVGOL.POLYORDER=2
cfg.EVALUATE.TRADITION_GAUS1D=CN()
cfg.EVALUATE.TRADITION_GAUS1D.WINDOW_SIZE=11
cfg.EVALUATE.TRADITION_GAUS1D.SIGMA=4
cfg.EVALUATE.TRADITION_ONEEURO=CN()
cfg.EVALUATE.TRADITION_ONEEURO.MIN_CUTOFF=0.004
